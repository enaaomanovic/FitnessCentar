...
{
    public class KomentariService : BaseService<Model.Komentari, Database.Komentari, KomentariSearchObject, KomentariInsertRequest, KomentariUpdateRequest>, IKomentariService
    {
