...
{
    public class NovostiService : BasedService<Model.Novosti, Database.Novosti, NovostiSearchObject, NovostiInsertRequest, NovostiUpdateRequest>, INovostiServices
    {
