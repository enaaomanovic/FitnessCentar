...
//   Korisnici? korisnik;
//   KorisniciReport? _currentReport;
...
//                 } else {
//                   await _userProvider
//                       .update(widget.korisnik!.id!, request);
//                 }

//                 // Generate and store the PDF before navigating to the detail page
//               //  Pdf.Document pdf = await _generatePdf();

//                 // Otvaranje ekrana sa detaljima korisnika i prosleđivanje podataka za PDF
//                 //  if (pdf.document.hasGraphicStates){
//                 //     Navigator.of(context).push(
//                 //       MaterialPageRoute(
//                 //         builder: (context) => DetailPage(report: _currentReport!),

//                 //       ),
//                 //     );
//                 //   } else {
//                 //     // Handle the case where _generatePdf returns an empty PDF
//                 //     print("Error: Unable to generate PDF");
//                 //   }
...
// // Future<Pdf.Document> _generatePdf() async {
// //   if (_formKey.currentState?.saveAndValidate() ?? false) {
// //     var formData = Map<String, dynamic>.from(_formKey.currentState!.value);

// //     // Example: Creating KorisniciReport object
// //     var korisniciReport = KorisniciReport(
// //       ime: formData['ime'],
...
// //       visina: formData['visina'],
// //       slika: formData['slika'],
// //       lozinka: formData['lozinka'],
// //     );

// //     // Example: Calling makePdf function
// //     final Pdf.Document pdf = await makePdf(korisniciReport);

// //     return pdf;
// //   }
// //   // Return a default document if form validation fails
// //   return Pdf.Document();
// // }

// //  Future<Pdf.Document> makePdf(KorisniciReport report) async {
...
// //           return Pdf.Column(
// //             children: [
// //               Pdf.Text('Customer Report'),
// //               Pdf.Divider(),
// //               Pdf.Text('Ime: ${report.ime}'),
// //               Pdf.Text('Prezime: ${report.prezime}'),
// //               Pdf.Text('Korisničko ime: ${report.korisnickoIme}'),
// //               Pdf.Text('Email: ${report.email}'),
// //               Pdf.Text('Telefon: ${report.telefon}'),
// //               Pdf.Text('Datum registracije: ${report.datumRegistracije}'),
// //               Pdf.Text('Datum rođenja: ${report.datumRodjenja}'),
// //               Pdf.Text('Pol: ${report.pol}'),
// //               Pdf.Text('Težina: ${report.tezina}'),
// //               Pdf.Text('Visina: ${report.visina}'),
// //               Pdf.Text('Slika: ${report.slika}'),
// //               Pdf.Text('Lozinka: ${report.lozinka}'),
...
class AddUser extends StatefulWidget {
  ...
  const AddUser({Key? key, this.korisnik,required this.report}) : super(key: key);
      ...
      SizedBox(
        ...
        child: ElevatedButton(
          onPressed: () async {
            Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) => PdfPreviewPage(invoice: widget.report),
            ),
          );
          },
          child: Text("Isprintaj korisnika"),
