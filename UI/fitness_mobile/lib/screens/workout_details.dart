...
class WorkoutDetailScreen extends StatefulWidget {
  int? treningid;
  int? rasporedId;
  WorkoutDetailScreen({Key? key, this.treningid, this.rasporedId})
      : super(key: key);
  @override
...
class _WorkoutDetailScreen extends State<WorkoutDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return MasterScreanWidget(
      child: Stack(
        children: [
          isLoading ? Container() : _workoutDetails(),
        ],
      ),
                      ...
                      builder: (context, rasporedSnapshot) {
                        if (rasporedSnapshot.connectionState ==
                          ...
                          return Column(
                            ...
                            children: [
                              _buildInfoRow(
                                  'Naziv treninga', trening.naziv ?? ""),
                              _buildInfoRow('Trajanje treninga',
                                  '${trening.trajanje} minuta'),
                              _buildInfoRow(
                                  'Opis treninga', trening.opis ?? ""),
                              SizedBox(height: 16),
                              Container(
                                ...
                                builder: (context, trenerSnapshot) {
                                  if (trenerSnapshot.connectionState ==
                                    ...
                                    final trenerImage = trener.slika != null
                                        ...
                                        : null;
                                    final trenerImageBytes =
                                        trener.slika != null
                                            ? Uint8List.fromList(
                                                base64Decode(trener.slika!))
                                            : null;
                                      ...
                                      children: [
                                        ...
                                        ClipOval(
                                          child: Container(
                                            ...
                                            height: 70.0,
                                            decoration: BoxDecoration(),
                                            child: trenerImageBytes != null &&
                                                    trenerImageBytes.isNotEmpty
                                                ? Image.memory(
                                                    trenerImageBytes,
                                                    width: 70.0,
                                                    height: 70.0,
